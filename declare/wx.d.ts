...
declare namespace wx {
    ...
    */
    ...
    /**
     * wx.getstorage_info 的同步版本
     */
    function getstorage_infoSync(): { keys: Array<string>, currentSize: number, limitSize: number };

    /**
     * 异步获取当前storage的相关信息
     */
    function getstorage_info(object: { success?: (res: { keys: Array<string>, currentSize: number, limitSize: number }) => void, fail?: (res?: any) => void, complete?: (res?: any) => void }): void;
