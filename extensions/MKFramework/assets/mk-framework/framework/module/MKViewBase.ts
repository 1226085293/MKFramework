...
const mkUIManage = mk_dynamic_module.default(import("../mk_ui_manage"));
...
export class MKViewBase extends MKLifeCycle {
	 ...
	 * @param config_ 关闭配置
	 */
	close(config_?: Omit<mk_ui_manage_.close_config<any>, "type" | "isAll">): void | Promise<void>;
	async close(config_?: Omit<mk_ui_manage_.close_config<any>, "type" | "isAll">): Promise<void> {
		// 不在关闭中或者已经关闭代表外部调用
